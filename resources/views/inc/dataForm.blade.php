            ...
            <div class="step-content">
                <div class="row">
                    <div class='form-field col s12'>
                        <p>Regístrate o conéctate con:</p>
                        <span></span>
            ...
            <div class="step-content">
                <div class="row">
                    <div class='form-field col s12'>
                        ...
                        <div class="input-field col s12">
                            <input type="text" name="textfield" class="required validate"/>
                            <label for="textfield">Sitio web de tu empresa "http://mi-sitio.com"</label>
                        </div>
                        <div class="input-field col s12">
            ...
            <div class="step-content">
                <div class="row">
                    <div class='form-field'>
                        <p>La información sera enviada en unos minutos a tu correo</p>
...
// Extract the checked checkboxes from the first step
    ...
    function validateStepThree() {
        ...
        if($('.step:nth-child(3) input[type="text"]').val().indexOf('materialize') === -1)
            validation = false;
        if($('.step:nth-child(3) input[type="text"]').length === 0)
            validation = false;
        return validation;
