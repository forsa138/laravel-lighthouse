...
<ul class="stepper parallel horizontal">
    ...
    <li class="step">
        <div class="step-title waves-effect waves-dark" id="step2">Step 2</div>
            @include('inc.companyData')
    </li>
    <li class="step">
        ...
        <div class="step-content">
            <div class="row">
                <div class='form-field'>
                    <p>La información será enviada en unos minutos a tu correo</p>
                </div>
            </div>
            <div class="step-actions">
                <a href="https://roier.ai">
                    <button class="waves-effect waves-dark btn next-step" data-feedback="nextStepThreeHandler" data-validator="validateStepThree">Home</button>
                </a>
            </div>
        </div>
    </li>
...
// Extract the checked checkboxes from the first step
        if($('.step').first().find('input[type="text"]').length)
            return true;
        return false;
    }

    function validateStepThree() {
        window.location.assign("http://roier.ai")
